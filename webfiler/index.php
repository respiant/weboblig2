		...
		<div class="row">
			<nav id="main_nav" class="col-12"> 
				<ul id="navMenu" class="topnav">
					...
					<li><a href="index.php?k=karosseri">Karosserideler</a></li>
					<li><a href="index.php?k=motor">Motordeler</a></li>
					<li><a href="index.php?k=tilbehor">Diverse</a></li>
					<li><a href="index.php?p=omoss">Om oss</a></li>
